...
def student_create():
    if request.method == 'GET':
        ...
        student = Student(first_name=first_name, last_name=last_name, student_email=student_email,
                          major_id=major_id, birth_date=dt.strptime(birth_date, '%Y-%m-%d'), is_honors=is_honors)

...
with app.app_context():
    ...
    users = [
        ...
        {'username': 'mteixei2', 'email': 'mteixei2@umd.edu', 'first_name': 'Charlie', 'last_name': 'Teixeira',
            'password': generate_password_hash('mteixei2', method='pbkdf2:sha256'), 'role': 'STUDENT'}
    ]
